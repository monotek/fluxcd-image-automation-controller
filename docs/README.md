...
| `GitPushRetryOnFailure`       | `false`       | Enables retrying a failed push (fetch, hard reset, re-apply policies, recommit, push again) instead of failing the reconciliation immediately.                                                                            |
