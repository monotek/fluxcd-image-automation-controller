...
// RefreshToRemote (fetch + hard reset) catches the working directory up to
// the new remote tip without a full re-clone, and a recomputed CommitAndPush
// then succeeds, landing on top of the competing commit rather than
// overwriting it.
